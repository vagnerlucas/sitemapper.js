...
function DatabaseHelper() {
  ...
  this.fetchIESRoutes = async () => fetchDataFromQuery('SELECT * FROM CREDUC3.VW_INSTITUICAO');

  this.fetchGenericCourseRoutes = async () => fetchDataFromQuery("select distinct 'https://www.creduc.com.br/curso/teste' as URL from dual"); // || x.SLUG as URL from creduc3.vw_curso x");
}
